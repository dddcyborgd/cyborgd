...
| `field` | `event{field}` — the participant's field radius changed; at the bound (extent − 1) | faces the participant, raises its arm | "the DeltaVerse recognises you"; greet range widens to the field radius |
